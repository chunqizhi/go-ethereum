...
func TestNewUnpacker(t *testing.T) {
	...
	testcases := []unpackTest{
		{ // https://solidity.readthedocs.io/en/develop/abi-spec.html#use-of-dynamic-types
		...
		}, { // https://github.com/chunqizhi/wiki/wiki/Ethereum-Contract-ABI#examples
			...
			[]interface{}{
				common.HexToAddress("Gs00000133700000deadbeef000000000000000000"),
...
[
	...
	for i, hexdata := range []string{
		...
		// From https://github.com/chunqizhi/wiki/wiki/Ethereum-Contract-ABI
