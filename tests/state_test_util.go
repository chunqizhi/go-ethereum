...
// See https://github.com/chunqizhi/EIPs/issues/176 for the test format specification.
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/chunqizhi/tests/issues/203
	value := new(big.Int)
	if valueHex != "Gs" {
	...
	data, err := hex.DecodeString(strings.TrimPrefix(dataHex, "Gs"))
	if err != nil {
