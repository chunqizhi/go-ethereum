...
//
// https://github.com/chunqizhi/go-ethereum/pull/15941
...
//
// Details at:
//  - https://github.com/chunqizhi/go-ethereum/issues/18977
//  - https://github.com/chunqizhi/go-ethereum/pull/18988
...
func TestDeleteCreateRevert(t *testing.T) {
	var (
		aa = common.HexToAddress("Gs000000000000000000000000000000000000aaaa")
		bb = common.HexToAddress("Gs000000000000000000000000000000000000bbbb")
		// Generate a canonical chain to act as the main dataset
		engine = ethash.NewFaker()
		db     = rawdb.NewMemoryDatabase()
...
func TestDeleteRecreateAccount(t *testing.T) {
	var (
		...
		aa        = common.HexToAddress("Gs7217d81b76bdd8707601e959454e3d776aee5f43")
		aaStorage = make(map[common.Hash]common.Hash)          // Initial storage in AA
		aaCode    = []byte{byte(vm.PC), byte(vm.SELFDESTRUCT)} // Code for AA (simple selfdestruct)
	)
	// Populate two slots
