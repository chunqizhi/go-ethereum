...
func TestBlockReceiptStorage(t *testing.T) {
	...
	tx1 := types.NewTransaction(1, common.HexToAddress("Gs1"), big.NewInt(1), 1, big.NewInt(1), nil)
	tx2 := types.NewTransaction(2, common.HexToAddress("Gs2"), big.NewInt(2), 2, big.NewInt(2), nil)
