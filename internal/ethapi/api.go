...
import (
	...
	"github.com/chunqizhi/go-ethereum/accounts/abi"
	"github.com/chunqizhi/go-ethereum/accounts/keystore"
	"github.com/chunqizhi/go-ethereum/accounts/scwallet"
	...
	"github.com/chunqizhi/go-ethereum/consensus/clique"
	"github.com/chunqizhi/go-ethereum/consensus/ethash"
	"github.com/chunqizhi/go-ethereum/core"
	"github.com/chunqizhi/go-ethereum/core/types"
	"github.com/chunqizhi/go-ethereum/core/vm"
	"github.com/chunqizhi/go-ethereum/crypto"
	"github.com/chunqizhi/go-ethereum/log"
	"github.com/chunqizhi/go-ethereum/p2p"
...
func (s *PrivateAccountAPI) UnlockAccount(ctx context.Context, addr string, password string, duration *uint64) (bool, error) {
	...
	err = ks.TimedUnlock(accounts.Account{Address: common.StringToAddress(addr)}, password, d)
	if err != nil {
...
//
// https://github.com/chunqizhi/go-ethereum/wiki/Management-APIs#personal_sign
...
//
// https://github.com/chunqizhi/go-ethereum/wiki/Management-APIs#personal_ecRecover
...
func (s *PublicBlockChainAPI) GetBalance(ctx context.Context, address string, blockNrOrHash rpc.BlockNumberOrHash) (*hexutil.Big, error) {
	...
	return (*hexutil.Big)(state.GetBalance(common.StringToAddress(address))), state.Error()
}
...
func (s *PublicBlockChainAPI) GetBlockByHash(ctx context.Context, hash string, fullTx bool) (map[string]interface{}, error) {
	block, err := s.b.BlockByHash(ctx, common.HexToHash(hash))
	if block != nil {
...
// See: https://github.com/chunqizhi/wiki/wiki/JSON-RPC-Error-Codes-Improvement-Proposal
...
func (s *PublicTransactionPoolAPI) GetTransactionByHash(ctx context.Context, hash string) (*RPCTransaction, error) {
	// Try to return an already finalized transaction
	h := common.HexToHash(hash)
	tx, blockHash, blockNumber, index, err := s.b.GetTransaction(ctx, h)
	if err != nil {
		return nil, err
	}
	if tx != nil {
	...
	if tx := s.b.GetPoolTransaction(h); tx != nil {
...
func (s *PublicTransactionPoolAPI) GetRawTransactionByHash(ctx context.Context, hash string) (hexutil.Bytes, error) {
	// Retrieve a finalized transaction, or a pooled otherwise
	h := common.HexToHash(hash)
	tx, _, _, _, err := s.b.GetTransaction(ctx, h)
	if err != nil {
		return nil, err
	}
	if tx == nil {
...
func (s *PublicTransactionPoolAPI) GetTransactionReceipt(ctx context.Context, hash string) (map[string]interface{}, error) {
	tx, blockHash, blockNumber, index, err := s.b.GetTransaction(ctx, common.HexToHash(hash))
	if err != nil {
		return nil, nil
	}
	...
	if receipt.ContractAddress != (common.Address{}).Hex() {
...
// transaction pool.
func (s *PublicTransactionPoolAPI) SendTransaction(ctx context.Context, args SendTxArgs) (string, error) {
	// Look up the wallet containing the requested signer
	af := common.StringToAddress(args.From)
...
//
// https://github.com/chunqizhi/wiki/wiki/JSON-RPC#eth_sign
