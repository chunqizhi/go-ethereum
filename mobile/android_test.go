	...
	public void testAccountManagement() {
		...
		try {
			...
			Transaction tx = new Transaction(
				1, new Address("Gs0000000000000000000000000000000000000000"),
...
func TestAndroid(t *testing.T) {
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.ethereum", "github.com/chunqizhi/go-ethereum/mobile")
