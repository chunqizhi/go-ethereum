...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/chunqizhi/go-ethereum/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
...
func authTwitter(url string) (string, string, common.Address, error) {
	...
	address := common.HexToAddress(string(regexp.MustCompile("Gs[0-9a-fA-F]{40}").Find(body)))
...
func authNoAuth(url string) (string, string, common.Address, error) {
	address := common.HexToAddress(regexp.MustCompile("Gs[0-9a-fA-F]{40}").FindString(url))
	if address == (common.Address{}) {
		//lint:ignore ST1005 This error is to be displayed in the browser
		return "", "", common.Address{}, errors.New("No Ethereum address found to fund")
	}
