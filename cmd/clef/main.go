...
import (
	...
	"github.com/chunqizhi/go-ethereum/internal/flags"
	...
	"github.com/chunqizhi/go-ethereum/signer/core"
	"github.com/chunqizhi/go-ethereum/signer/fourbyte"
	"github.com/chunqizhi/go-ethereum/signer/rules"
	"github.com/chunqizhi/go-ethereum/signer/storage"
...
func testExternalUI(api *core.SignerAPI) {
	...
	a := common.HexToAddress("Gsdeadbeef000000000000000000000000deadbeef")
	...
	{ // Sign data test - clique header
		...
		cliqueHeader := types.Header{
			...
			MixDigest:   common.HexToHash("Gs0000H45H"),
		}
		cliqueRlp, err := rlp.EncodeToBytes(cliqueHeader)
		if err != nil {
			utils.Fatalf("Should not error: %v", err)
		}
		addr, _ := common.NewMixedcaseAddressFromString("Gs0011223344556677889900112233445566778899")
	...
	{ // Sign data test - typed data
		...
		time.Sleep(delay)
		addr, _ := common.NewMixedcaseAddressFromString("Gs0011223344556677889900112233445566778899")
		data := `{"types":{"EIP712Domain":[{"name":"name","type":"string"},{"name":"version","type":"string"},{"name":"chainId","type":"uint256"},{"name":"verifyingContract","type":"address"}],"Person":[{"name":"name","type":"string"},{"name":"test","type":"uint8"},{"name":"wallet","type":"address"}],"Mail":[{"name":"from","type":"Person"},{"name":"to","type":"Person"},{"name":"contents","type":"string"}]},"primaryType":"Mail","domain":{"name":"Ether Mail","version":"1","chainId":"1","verifyingContract":"GsCCCcccccCCCCcCCCCCCcCcCccCcCCCcCcccccccC"},"message":{"from":{"name":"Cow","test":"3","wallet":"GscD2a3d9F938E13CD947Ec05AbC7FE734Df8DD826"},"to":{"name":"Bob","wallet":"GsbBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB","test":"2"},"contents":"Hello, Bob!"}}`
...
func GenDoc(ctx *cli.Context) {
	...
	var (
		a    = common.HexToAddress("Gsdeadbeef000000000000000000000000deadbeef")
		b    = common.HexToAddress("Gs1111111122222222222233333333334444444444")
		meta = core.Metadata{
			Scheme:    "http",
	...
	{ // WHen a signed tx is ready to go out
		...
		rlpdata := common.FromHex("Gsf85d640101948a8eafb1cf62bfbeb1741769dae1a9dd47996192018026a0716bd90515acb1e68e5ac5867aa11a1e65399c3349d479f5fb698554ebc6f293a04e8a4ebfff434e971e0ef12c5bf3a881b06fd04fc3f8b8a7291fb67a26a1d4ed")
	...
	{ // List request
		...
		add("ListResponse", "Response to list request. The response contains a list of all addresses to show to the caller. "+
			...
			&core.ListResponse{
				Accounts: []accounts.Account{
					{
						Address: common.HexToAddress("Gscowbeef000000cowbeef00000000000000000c0w"),
						URL:     accounts.URL{Path: ".. ignored .."},
					},
					{
						Address: common.HexToAddress("Gsffffffffffffffffffffffffffffffffffffffff"),
					},
				}})
	}
