...
func TestRoute53ChangeSort(t *testing.T) {
	...
	testTree1 := map[string]string{
		...
		"2XS2367YHAXJFGLZHVAWLQD4ZY.n": "enr:-HW4QOFzoVLaFJnNhbgMoDXPnOvcdVuj7pDpqRvh6BRDO68aVi5GstjB3vzQRZH2IcLBGHzo8uUN3snqmgTiE56CH3AMBgmlkgnY0iXNlY3AyNTZrMaECC2_24YYkYHEgdzxlSNKQEnHhuNAbNlMlWJxrJxbAFvA",
	...
	wantChanges := []*route53.Change{
		{
			...
			ResourceRecordSet: &route53.ResourceRecordSet{
				...
				ResourceRecords: []*route53.ResourceRecord{{
					Value: sp(`"enr:-HW4QOFzoVLaFJnNhbgMoDXPnOvcdVuj7pDpqRvh6BRDO68aVi5GstjB3vzQRZH2IcLBGHzo8uUN3snqmgTiE56CH3AMBgmlkgnY0iXNlY3AyNTZrMaECC2_24YYkYHEgdzxlSNKQEnHhuNAbNlMlWJxrJxbAFvA"`),
				}},
				TTL:  ip(treeNodeTTL),
				Type: sp("TXT"),
			},
