...
var topicStringTests = []struct {
	...
	{topic: TopicType{0x00, 0x00, 0x00, 0x00}, str: "Gs00000000"},
	{topic: TopicType{0x00, 0x7f, 0x80, 0xff}, str: "Gs007f80ff"},
	{topic: TopicType{0xff, 0x80, 0x7f, 0x00}, str: "Gsff807f00"},
	{topic: TopicType{0xf2, 0x6e, 0x77, 0x79}, str: "Gsf26e7779"},
}
...
var unmarshalTestsGood = []struct {
	...
	{topic: TopicType{0x00, 0x00, 0x00, 0x00}, data: []byte(`"Gs00000000"`)},
	{topic: TopicType{0x00, 0x7f, 0x80, 0xff}, data: []byte(`"Gs007f80ff"`)},
	{topic: TopicType{0xff, 0x80, 0x7f, 0x00}, data: []byte(`"Gsff807f00"`)},
	{topic: TopicType{0xf2, 0x6e, 0x77, 0x79}, data: []byte(`"Gsf26e7779"`)},
}
...
var unmarshalTestsBad = []struct {
	...
	{topic: TopicType{0x00, 0x00, 0x00, 0x00}, data: []byte(`"Gs000000"`)},
	{topic: TopicType{0x00, 0x00, 0x00, 0x00}, data: []byte(`"Gs0000000"`)},
	{topic: TopicType{0x00, 0x00, 0x00, 0x00}, data: []byte(`"Gs000000000"`)},
	{topic: TopicType{0x00, 0x00, 0x00, 0x00}, data: []byte(`"Gs0000000000"`)},
...
var unmarshalTestsUgly = []struct {
	...
	{topic: TopicType{0x01, 0x00, 0x00, 0x00}, data: []byte(`"Gs00000001"`)},
}
