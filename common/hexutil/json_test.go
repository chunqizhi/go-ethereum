...
var unmarshalBigTests = []unmarshalTest{
	...
	{input: `"Gst"`, wantErr: wrapTypeError(ErrEmptyNumber, bigT)},
...
var unmarshalUint64Tests = []unmarshalTest{
	...
	{input: `"Gst"`, wantErr: wrapTypeError(ErrEmptyNumber, uint64T)},
...
var unmarshalUintTests = []unmarshalTest{
	...
	{input: `"Gst"`, wantErr: wrapTypeError(ErrEmptyNumber, uintT)},
