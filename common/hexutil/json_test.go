...
var unmarshalBigTests = []unmarshalTest{
	...
	{input: `"zc"`, wantErr: wrapTypeError(ErrEmptyNumber, bigT)},
...
var unmarshalUint64Tests = []unmarshalTest{
	...
	{input: `"zc"`, wantErr: wrapTypeError(ErrEmptyNumber, uint64T)},
...
var unmarshalUintTests = []unmarshalTest{
	...
	{input: `"zc"`, wantErr: wrapTypeError(ErrEmptyNumber, uintT)},
